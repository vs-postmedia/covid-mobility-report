...
var src_duration = __webpack_require__(0);

// EXTERNAL MODULE: ./node_modules/d3-time/src/interval.js
var src_interval = __webpack_require__(1);

// CONCATENATED MODULE: ./node_modules/d3-time/src/millisecond.js


var millisecond = Object(src_interval["a" /* default */])(function() {
  // noop
}, function(date, step) {
...
millisecond.every = function(k) {
  ...
  return Object(src_interval["a" /* default */])(function(date) {
...
var second_second = Object(src_interval["a" /* default */])(function(date) {
  date.setTime(date - date.getMilliseconds());
}, function(date, step) {
  date.setTime(+date + step * src_duration["e" /* durationSecond */]);
}, function(start, end) {
  return (end - start) / src_duration["e" /* durationSecond */];
}, function(date) {
...
var minute_minute = Object(src_interval["a" /* default */])(function(date) {
  date.setTime(date - date.getMilliseconds() - date.getSeconds() * src_duration["e" /* durationSecond */]);
}, function(date, step) {
  date.setTime(+date + step * src_duration["c" /* durationMinute */]);
}, function(start, end) {
  return (end - start) / src_duration["c" /* durationMinute */];
}, function(date) {
...
var hour_hour = Object(src_interval["a" /* default */])(function(date) {
  date.setTime(date - date.getMilliseconds() - date.getSeconds() * src_duration["e" /* durationSecond */] - date.getMinutes() * src_duration["c" /* durationMinute */]);
}, function(date, step) {
  date.setTime(+date + step * src_duration["b" /* durationHour */]);
}, function(start, end) {
  return (end - start) / src_duration["b" /* durationHour */];
}, function(date) {
...
var src_day = __webpack_require__(46);

// EXTERNAL MODULE: ./node_modules/d3-time/src/week.js
var src_week = __webpack_require__(10);

// CONCATENATED MODULE: ./node_modules/d3-time/src/month.js


var month_month = Object(src_interval["a" /* default */])(function(date) {
  date.setDate(1);
...
var src_year = __webpack_require__(20);

// CONCATENATED MODULE: ./node_modules/d3-time/src/utcMinute.js



var utcMinute = Object(src_interval["a" /* default */])(function(date) {
...
var utcHour = Object(src_interval["a" /* default */])(function(date) {
...
var utcDay = __webpack_require__(45);

// EXTERNAL MODULE: ./node_modules/d3-time/src/utcWeek.js
var utcWeek = __webpack_require__(9);

// CONCATENATED MODULE: ./node_modules/d3-time/src/utcMonth.js


var utcMonth = Object(src_interval["a" /* default */])(function(date) {
  date.setUTCDate(1);
...
var utcYear = __webpack_require__(19);
...
function ticker(year, month, week, day, hour, minute) {
  ...
  const tickIntervals = [
    [src_second,  1,      src_duration["e" /* durationSecond */]],
    [src_second,  5,  5 * src_duration["e" /* durationSecond */]],
    [src_second, 15, 15 * src_duration["e" /* durationSecond */]],
    [src_second, 30, 30 * src_duration["e" /* durationSecond */]],
    [minute,  1,      src_duration["c" /* durationMinute */]],
    [minute,  5,  5 * src_duration["c" /* durationMinute */]],
    [minute, 15, 15 * src_duration["c" /* durationMinute */]],
    [minute, 30, 30 * src_duration["c" /* durationMinute */]],
    [  hour,  1,      src_duration["b" /* durationHour */]  ],
    [  hour,  3,  3 * src_duration["b" /* durationHour */]  ],
    [  hour,  6,  6 * src_duration["b" /* durationHour */]  ],
    [  hour, 12, 12 * src_duration["b" /* durationHour */]  ],
    [   day,  1,      src_duration["a" /* durationDay */]   ],
    [   day,  2,  2 * src_duration["a" /* durationDay */]   ],
    [  week,  1,      src_duration["f" /* durationWeek */]  ],
    [ month,  1,      src_duration["d" /* durationMonth */] ],
    [ month,  3,  3 * src_duration["d" /* durationMonth */] ],
    [  year,  1,      src_duration["g" /* durationYear */]  ]
  ];
  ...
  function tickInterval(start, stop, count) {
    ...
    if (i === tickIntervals.length) return year.every(tickStep(start / src_duration["g" /* durationYear */], stop / src_duration["g" /* durationYear */], count));
...
const [utcTicks, utcTickInterval] = ticker(utcYear["a" /* default */], src_utcMonth, utcWeek["b" /* utcSunday */], utcDay["a" /* default */], src_utcHour, src_utcMinute);
const [timeTicks, timeTickInterval] = ticker(src_year["a" /* default */], src_month, src_week["b" /* sunday */], src_day["a" /* default */], src_hour, src_minute);



// EXTERNAL MODULE: ./node_modules/d3-time-format/src/defaultLocale.js
var src_defaultLocale = __webpack_require__(24);
...
function time_time() {
  return initRange.apply(calendar(timeTicks, timeTickInterval, src_year["a" /* default */], src_month, src_week["b" /* sunday */], src_day["a" /* default */], src_hour, src_minute, src_second, src_defaultLocale["a" /* timeFormat */]).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
}
...
function utcTime() {
  return initRange.apply(calendar(utcTicks, utcTickInterval, utcYear["a" /* default */], src_utcMonth, utcWeek["b" /* utcSunday */], utcDay["a" /* default */], src_utcHour, src_utcMinute, src_second, src_defaultLocale["b" /* utcFormat */]).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
}
...
/* harmony import */ var _interval_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
...
/* harmony import */ var _locale_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
...
"use strict";
/* harmony import */ var _defaultLocale_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
...
/* harmony import */ var d3_time__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var d3_time__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45);
/* harmony import */ var d3_time__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var d3_time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);
/* harmony import */ var d3_time__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20);
/* harmony import */ var d3_time__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(19);
...
var global = __webpack_require__(6);
var userAgent = __webpack_require__(238);
